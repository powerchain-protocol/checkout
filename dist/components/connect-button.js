...
export function ConnectButton({ className = "" }) {
    ...
    if (connected && publicKey) {
        return (_jsxs("button", { className: `pp-connect-button pp-connected ${className}`, type: "button", onClick: () => void disconnect(), title: "Disconnect wallet", children: [_jsx("span", { className: "pp-status-dot" }), shortenPublicKey(publicKey)] }));
    }
