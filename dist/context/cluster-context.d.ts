...
export declare function ClusterProvider({ initialCluster, children, ...options }: ClusterProviderProps): React.JSX.Element;
export declare function usePowerPayCluster(): ClusterContextValue;
//# sourceMappingURL=cluster-context.d.ts.map