...
(/* @__PURE__ */ __commonJSMin((() => {
	...
	if (!globalThis.ReadableStream) try {
		const process = require_browser_external_node_process();
...
var require_node_domexception = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	if (!globalThis.DOMException) try {
		const { MessageChannel } = require_browser_external_worker_threads(), port = new MessageChannel().port1, ab = /* @__PURE__ */ new ArrayBuffer();
...
var import_browser_external_node_path = require_browser_external_node_path();
var import_node_domexception = /* @__PURE__ */ __toESM(require_node_domexception());
var { stat } = import_browser_external_node_fs.promises;
/**
* @param {string} path filepath on the disk
* @param {string} [type] mimetype to use
*/
var blobFromSync = (path, type) => fromBlob((0, import_browser_external_node_fs.statSync)(path), path, type);
/**
* @param {string} path filepath on the disk
* @param {string} [type] mimetype to use
* @returns {Promise<Blob>}
*/
var blobFrom = (path, type) => stat(path).then((stat) => fromBlob(stat, path, type));
/**
* @param {string} path filepath on the disk
* @param {string} [type] mimetype to use
* @returns {Promise<File>}
*/
var fileFrom = (path, type) => stat(path).then((stat) => fromFile(stat, path, type));
/**
* @param {string} path filepath on the disk
* @param {string} [type] mimetype to use
*/
var fileFromSync = (path, type) => fromFile((0, import_browser_external_node_fs.statSync)(path), path, type);
var fromBlob = (stat, path, type = "") => new Blob([new BlobDataItem({
	path,
	size: stat.size,
	lastModified: stat.mtimeMs,
	start: 0
})], { type });
var fromFile = (stat, path, type = "") => new File([new BlobDataItem({
	path,
	size: stat.size,
	lastModified: stat.mtimeMs,
	start: 0
})], (0, import_browser_external_node_path.basename)(path), {
	type,
	lastModified: stat.mtimeMs
});
/**
...
var BlobDataItem = class BlobDataItem {
	...
	*/
	...
	async *stream() {
		...
		yield* (0, import_browser_external_node_fs.createReadStream)(this.#path, {
			start: this.#start,
...
//#endregion
export { FormData as a, Blob as c, fileFromSync as i, blobFromSync as n, formDataToBlob as o, fileFrom as r, File as s, blobFrom as t };
